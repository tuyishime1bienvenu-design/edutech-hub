...
CREATE INDEX IF NOT EXISTS idx_job_postings_active ON public.job_postings(is_active, application_deadline);
...
CREATE INDEX IF NOT EXISTS idx_job_applications_key ON public.job_applications(application_key);
