...
CREATE INDEX idx_materials_category ON public.materials_inventory(category);
CREATE INDEX idx_materials_active ON public.materials_inventory(is_active);
CREATE INDEX idx_wifi_active ON public.wifi_networks(is_active);
CREATE INDEX idx_transactions_material ON public.material_transactions(material_id);
CREATE INDEX idx_transactions_recipient ON public.material_transactions(recipient_id);
CREATE INDEX idx_transactions_date ON public.material_transactions(transaction_date);
